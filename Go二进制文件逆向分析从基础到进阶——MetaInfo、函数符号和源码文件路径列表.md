...
可以看到，第三种编译方式生成的 PIE 文件，是没有 `.gopclntab` 这个 Section 的，而是多了一些重定向相关的 Section。这也是前文《[Go二进制文件逆向分析从基础到进阶——综述](https://www.anquanke.com/post/id/214940)》中 **redress** 工具报错的原因：它根据 Section Name 查找 **pclntabl** 的思路，对 PIE 文件无效。
